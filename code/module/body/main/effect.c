...
void rainbow_task() {
    ...
    const float per_module_offset = M_PI / 8;
    ...
    for (;;) {
        ...
        float start_offset = per_module_offset  - 0.5f;
        ...
        float end_offset = per_module_offset + 0.5f;
        ...
        message_callback((struct Message *) &light_message);
